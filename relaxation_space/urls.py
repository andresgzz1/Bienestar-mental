...
urlpatterns = [
    ...
    path('adminView_rp_sound/<idsound>/',
         views.adminView_rp_sounds, name='adminView_rp_sound'),
    path('add_sound_rp/<idsound>/', views.add_sound_rp, name='add_sound_rp'),
    path('delete_sound_rp/<idsound>/',
         views.delete_sound_rp, name='delete_sound_rp'),
    path('update_sound_rp/<idsound>/',
         views.update_sound_rp, name='update_sound_rp'),
